...
<style>
	...
	:global(.global-task-scoreboard th.login) { width: 60%; }
	:global(.global-task-scoreboard th.fio)   { width: 42%; }
	:global(.global-task-scoreboard th.time)  { width: 40%; }
    ...
    .scoreboard {
  	...
  	:global(.global-task-scoreboard th.login) { width: 30%; }
  	:global(.global-task-scoreboard th.time)   { width: 28%; }
    :global(.global-task-scoreboard .fio) {
      display: table-cell;
    }
  }
