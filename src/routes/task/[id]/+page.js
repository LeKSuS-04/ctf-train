    ...
    return {
      ...
      solvers: [
        ...
        { id: 4, login: "senior", fio: "веселов", time: "2018-12-22 18:20:55" },
        {
          id: 5,
          login: "BadWolf",
          fio: "Краснопольский Иван Денисович",
          time: "2019-09-28 20:21:36"
        },
        ...
        { id: 8, login: "liza", fio: "Авдеева Елизавета", time: "2022-01-30 21:46:21" },
        {
          id: 9,
          login: "Mihafil746",
          fio: "Фильчуков Михаил Денисович",
          time: "2022-03-03 21:30:35"
        }
      ]
    };
  if (params.id == 5)
    return {
      ...
      cost: 150,
      description:
        "сервер https://link.here  Зайдите за админа. Пароль состоит из 5 символов из набора 'pwd', каждый символ может встречаться любое количество раз.",
      solvers: [
        { id: 0, login: "silent", fio: "Першин Максим", time: "2017-11-01 17:35:07" },
        { id: 1, login: "Raneddo", fio: "Липатов Роман Викторович", time: "2017-11-09 22:02:25" },
        { id: 2, login: "keker", fio: "kek", time: "2017-11-17 18:48:57" },
